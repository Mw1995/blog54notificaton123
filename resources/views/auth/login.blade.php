                       ...
                       <div class="alert alert-danger display-hide">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                             ...
                             <i class="fa fa-user"></i>
                                ...
                                <input id="email" type="email" class="form-control placeholder-no-fix" name="email" value="{{ old('email') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="input-icon">
                               <i class="fa fa-lock"></i>
                                <input id="password" type="password" class="form-control placeholder-no-fix" name="password" required>
